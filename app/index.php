...
<body data-theme="blue">
    ...
    <script>
        ...
        const privacyContent = {
            tr: `
                <h3>Veri Toplama</h3>
                <p>SITEMIZ olarak, ziyaretçilerimizin gizliliğine önem veriyoruz. Bakım sayfası sırasında aşağıdaki verileri topluyoruz:</p>
                <ul>
            ...
            en: `
                ...
                <p>At SITEMIZ, we value our visitors' privacy. During maintenance, we collect the following data:</p>
                <ul>
            ...
            de: `
                ...
                <p>Bei SITEMIZ schätzen wir die Privatsphäre unserer Besucher. Während der Wartung erfassen wir folgende Daten:</p>
                <ul>
            ...
            fr: `
                ...
                <p>Chez SITEMIZ, nous valorisons la vie privée de nos visiteurs. Pendant la maintenance, nous collectons les données suivantes :</p>
                <ul>
            ...
            es: `
                ...
                <p>En SITEMIZ, valoramos la privacidad de nuestros visitantes. Durante el mantenimiento, recopilamos los siguientes datos:</p>
                <ul>
            ...
            it: `
                <h3>Raccolta Dati</h3>
                <p>In SITEMIZ, apprezziamo la privacy dei nostri visitatori. Durante la manutenzione, raccogliamo i seguenti dati:</p>
                <ul>
            ...
            ja: `
                <h3>データ収集</h3>
                <p>SITEMIZでは、訪問者のプライバシーを尊重しています。メンテナンス中に以下のデータを収集します：</p>
                <ul>
                    <li>IPアドレス（匿名化）</li>
                    <li>ブラウザの種類とバージョン</li>
                    <li>訪問時刻と日付</li>
            ...
            ko: `
                <h3>데이터 수집</h3>
                <p>SITEMIZ에서는 방문자의 개인정보를 소중히 여깁니다. 점검 중 다음 데이터를 수집합니다:</p>
                <ul>
                    <li>IP 주소 (익명화)</li>
                    <li>브라우저 유형 및 버전</li>
                    <li>방문 시간 및 날짜</li>
            ...
            ar: `
                <h3>جمع البيانات</h3>
                <p>في SITEMIZ، نحن نقدر خصوصية زوارنا. أثناء الصيانة، نقوم بجمع البيانات التالية:</p>
                <ul>
            ...
            ru: `
                <h3>Сбор Данных</h3>
                <p>В SITEMIZ мы ценим конфиденциальность наших посетителей. Во время обслуживания мы собираем следующие данные:</p>
                <ul>
        ...
        const termsContent = {
            tr: `
                ...
                <p>SITEMIZ şu anda planlı bakım çalışmaları nedeniyle geçici olarak kullanılamamaktadır. Bu kesinti sırasında:</p>
                <ul>
                ...
                <p>Bu bakım sayfasının tüm içeriği SITEMIZ'a aittir ve telif hakkı yasalarıyla korunmaktadır.</p>

                <h3>Değişiklik Hakkı</h3>
                <p>SITEMIZ, bu kullanım koşullarını herhangi bir zamanda değiştirme hakkını saklı tutar.</p>
            `,
            en: `
                <h3>Acceptance</h3>
                ...
                <p>SITEMIZ is currently temporarily unavailable due to planned maintenance work. During this outage:</p>
                <ul>
                ...
                <p>All content of this maintenance page belongs to SITEMIZ and is protected by copyright laws.</p>

                <h3>Right to Modify</h3>
                <p>SITEMIZ reserves the right to modify these terms of use at any time.</p>
            `,
            de: `
                <h3>Annahme</h3>
                ...
                <p>SITEMIZ ist derzeit aufgrund geplanter Wartungsarbeiten vorübergehend nicht verfügbar. Während dieser Unterbrechung:</p>
                <ul>
                ...
                <p>Der gesamte Inhalt dieser Wartungsseite gehört SITEMIZ und ist urheberrechtlich geschützt.</p>

                <h3>Änderungsrecht</h3>
                <p>SITEMIZ behält sich das Recht vor, diese Nutzungsbedingungen jederzeit zu ändern.</p>
            `,
            fr: `
                <h3>Acceptation</h3>
                ...
                <p>SITEMIZ est actuellement temporairement indisponible en raison de travaux de maintenance planifiés. Pendant cette interruption :</p>
                <ul>
                ...
                <p>Tout le contenu de cette page de maintenance appartient à SITEMIZ et est protégé par les lois sur le droit d'auteur.</p>

                <h3>Droit de Modification</h3>
                <p>SITEMIZ se réserve le droit de modifier ces conditions d'utilisation à tout moment.</p>
            `,
            es: `
                <h3>Aceptación</h3>
                ...
                <p>SITEMIZ está actualmente temporalmente no disponible debido a trabajos de mantenimiento planificados. Durante esta interrupción:</p>
                <ul>
                ...
                <p>Todo el contenido de esta página de mantenimiento pertenece a SITEMIZ y está protegido por las leyes de derechos de autor.</p>

                <h3>Derecho a Modificar</h3>
                <p>SITEMIZ se reserva el derecho de modificar estos términos de uso en cualquier momento.</p>
            `,
            it: `
                <h3>Accettazione</h3>
                ...
                <p>SITEMIZ è attualmente temporaneamente non disponibile a causa di lavori di manutenzione programmati. Durante questa interruzione:</p>
                <ul>
                    <li>La funzionalità normale del sito è disabilitada</li>
                ...
                <p>Tutto il contenuto di questa pagina di manutenzione appartiene a SITEMIZ ed è protetto dalle leggi sul copyright.</p>

                <h3>Diritto di Modifica</h3>
                <p>SITEMIZ si riserva il diritto di modificare questi termini di utilizzo in qualsiasi momento.</p>
            `,
            ja: `
                <h3>承諾</h3>
                ...
                <h3>サービス中断</h3>
                <p>SITEMIZは現在、計画的なメンテナンス作業のため一時的に利用できません。この中断中：</p>
                <ul>
                    <li>通常のサイト機能は無効です</li>
                ...
                <h3>知的財産</h3>
                <p>このメンテナンスページのすべてのコンテンツはSITEMIZに属し、著作権法で保護されています。</p>

                <h3>変更権</h3>
                <p>SITEMIZは、これらの利用規約を随時変更する権利を留保します。</p>
            `,
            ko: `
                <h3>수락</h3>
                ...
                <h3>서비스 중단</h3>
                <p>SITEMIZ는 현재 계획된 점검 작업으로 인해 일시적으로 사용할 수 없습니다. 이 중단期間 동안:</p>
                <ul>
                ...
                <h3>지적 재산권</h3>
                <p>이 점검 페이지의 모든 콘텐츠는 SITEMIZ에 속하며 저작권법으로 보호됩니다.</p>

                <h3>수정 권한</h3>
                <p>SITEMIZ는 본 이용 약관을 언제든지 수정할 권리를 보유합니다.</p>
            `,
            ar: `
                <h3>القبول</h3>
                ...
                <h3>انقطاع الخدمة</h3>
                <p>SITEMIZ غير متاح حاليًا مؤقتًا due لأعمال الصيانة المخطط لها. خلال هذا الانقطاع:</p>
                <ul>
                ...
                <p>جميع محتويات صفحة الصيانة هذه مملوكة لـ SITEMIZ ومحمية بقوانين حقوق النشر.</p>

                <h3>حق التعديل</h3>
                <p>تحتفظ SITEMIZ بالحق في تعديل شروط الاستخدام هذه في أي وقت.</p>
            `,
            ru: `
                <h3>Принятие</h3>
                ...
                <p>SITEMIZ в настоящее время временно недоступен due к плановым работам по техническому обслуживанию. Во время этого перерыва:</p>
                <ul>
                ...
                <p>Весь контент этой страницы обслуживания принадлежит SITEMIZ и защищен законами об авторском праве.</p>

                <h3>Право на Изменение</h3>
                <p>SITEMIZ оставляет за собой право изменять эти условия использования в любое время.</p>
            `
        };
        ...
        function updateLanguage(lang) {
            ...
            document.getElementById('privacyModalBody').innerHTML = (privacyContent[lang] || privacyContent.tr).replace(/SITEMIZ/g, siteName);
            document.getElementById('termsModalBody').innerHTML = (termsContent[lang] || termsContent.tr).replace(/SITEMIZ/g, siteName);

            // Tarihleri güncelle
            const now = new Date();
            document.getElementById('privacyDate').textContent = now.toLocaleDateString(lang);
            document.getElementById('termsDate').textContent = now.toLocaleDateString(lang);
        }
